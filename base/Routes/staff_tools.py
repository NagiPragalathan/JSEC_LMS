...
def Staff_toolHome(request):
    return render(request, "Staff_Page_Tools/Staff_tool.html")


def Staff_base(request):
    return render(request, "Staff_Page_Tools/Staff_base.html")


def Staff_Code_scriping(request):
    context = {}
    ...
    return render(request, 'Staff_Page_Tools/CodeScriping.html', context)


def Staff_calculator(request):
    return render(request, 'Staff_Page_Tools/calculator.html')


def Staff_translate_(request):
    ...
    return render(request, 'Staff_Page_Tools/translate.html', context)


def Staff_convert_text(request):
    if request.method == 'POST':
        ...
        with open(filename, 'rb') as f:
            ...
            return response
    return render(request, 'Staff_Page_Tools/text_to_audio.html')


def Staff_wikipedia_summary(request):
    if request.method == 'POST':
        ...
        try:
            ...
            if request.POST.get('action') == 'view':
                return render(request, 'Staff_Page_Tools/wikipedia_summary.html', {"summary": summary})
        ...
        return render(request, 'Staff_Page_Tools/wikipedia_summary.html')


def Staff_convert_docx_to_pdf(request):
    if request.method == 'POST' and request.FILES['docx_file']:
        ...
        return render(request, 'Staff_Page_Tools/convert_docx_to_pdf.html')


def Staff_convert_pdf_to_docx(request):
    ...
    return render(request, 'Staff_Page_Tools/convert_pdf_to_docx.html')


def Staff_convert_pdf_to_excel(request):
    if request.method == 'POST' and request.FILES['pdf_file']:
        ...
        return render(request, 'Staff_Page_Tools/convert_pdf_to_excel.html')


def Staff_convert_excel_to_pdf(request):
    ...
    return render(request, 'Staff_Page_Tools/convert_excel_to_pdf.html')


def Staff_convert_images_to_pdf(images):
...
def Staff_convert_jpg_to_pdf(request):
    if request.method == 'POST':
    ...
    return render(request, 'Staff_Page_Tools/convert_jpg_to_pdf.html')


def Staff_convert_jpg_to_word(request):
    ...
    return render(request, 'Staff_Page_Tools/convert_jpg_to_word.html')


def Staff_cgpa_calculator(request):
    if request.method == 'POST':
        total_credits = 0
        ...
        try:
            ...
            context = {'cgpa': 'cgpa', 'len': [i for i in range(1, 10)]}
            print("error/...")
        return render(request, 'Staff_Page_Tools/cgpa_calculator.html', context)
    else:
        return render(request, 'Staff_Page_Tools/cgpa_calculator.html', context)


def Staff_get_grade_points(grade):
    if grade == 'S':
        return 10
    elif grade == 'A':
        return 9
...
def Staff_get_subject(request):
    if request.method == 'POST':
        num = request.POST.get('number')
        print(type(int(num)))
        return render(request, 'Staff_Page_Tools/gpa_calculator.html', {'num_sub': [i for i in range(1, int(num)+1)]})

    return render(request, 'Staff_Page_Tools/num_of_sub.html')


def Staff_gpa_calculator(request):
    ...
    return render(request, 'Staff_Page_Tools/gpa_calculator.html', context)
# >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>


def Staff_handwriting_converter(request):
    return render(request, 'Staff_Page_Tools/handwriting.html')
...
def Staff_keyword_to_image(request):
    if request.method == 'POST':
        keyword = request.POST.get('keyword')
        urls = get_image_url(keyword)
        print(keyword, urls)
        return render(request, 'Staff_Page_Tools/keyword_to_image.html', {'image_urls': urls})
    return render(request, 'Staff_Page_Tools/keyword_to_image.html')

# views.py


def Staff_video_meeting(request):
    return render(request, 'Staff_Page_Tools/video_meeting.html')


def Staff_Staff_tool(request):
    return render(request, "Staff_Page_Tools/Staff_tool.html")
